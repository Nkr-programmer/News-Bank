...
int done=0;
  ...
  print("x");
  if(c==1){homeNewsDatas=homeNewsData;print(homeNewsDatas.toString());}
    else {homeNewsDatas.add(homeNewsData); print(homeNewsDatas.toString());}
                 print(" HHH");
                    ...
                    children: [
                      Transform(
                        ...
                        child: Container(
                         ...
                         homeNewsDatas[index]["category"]["bg_color_code"]
                                  .substring(1, 7),
                            ):Colors.white),
                      ),
                      Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: heading(
                                            text: homeNewsDatas[index]
                                                ["category"]["title"],
                                            color:dark==0 ?hexColor(homeNewsDatas[index]
                                                        ["category"]
                                                    ["text_color_code"]
                                                  ...
                                                  children: [
                                                    ...
                                                    GestureDetector(
                                                      onTap: () {
                                                        FlutterShare.share(
                                                            title: "Title",
                                                            text: homeNewsDatas[index]["news"][index2]["title"],
                                                            chooserTitle:
                                                                "इस खबर को शेयर करो...");
                                                      },
                                                      child: Icon(
